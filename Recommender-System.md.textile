h2(#a-guide-for-making-choices...). A guide for making choices...

bq. [...] any system that produces individualised recommendations as output or has the effect of guiding users in a personalized way to interesting or useful objects in a large space of possible options.
...
h2(#relying-on-collective-knowledge...). Relying on collective knowledge...

bq. Social information filtering essentially automates the process of &quot;word-of-mouth&quot; recommendations...
...
bq. Recommender systems use the opinions of a community of users to help individuals in that community to more effectively identify content of interest from a potentially overwhelming set of choices.
(Herlocker et al.(2004), Evaluating collaborative filtering recommender systems)



h3(#generating-recommendations). Generating recommendations
